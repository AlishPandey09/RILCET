...
const AdminLogin = () => {
    ...
    return (
        <div className="relative overflow-hidden admin-login flex flex-col justify-center items-center px-8 py-8 sm:px-12 md:px-20 lg:px-40 lg:py-24 h-screen w-full bg-primaryColor">
            ...
            <div ref={circle1} className="absolute bg-red-700/30 blur-3xl w-60 h-60 sm:w-80 sm:h-80 -right-24 -top-24"></div>
            <div ref={circle2} className="absolute bg-blue-700/30 blur-3xl w-60 h-60 sm:w-80 sm:h-80 top-1/3 -left-24"></div>
            <div ref={circle3} className="absolute bg-orange-600/40 blur-3xl w-60 h-60 sm:w-80 sm:h-80 -bottom-24 -right-24"></div>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center shadow-lg border-2 border-gray-300 text-tertiaryColor p-8 sm:p-12 md:p-16 rounded-3xl w-full max-w-lg">
                ...
                {showOtpInput && (
                    <>
                        ...
                        />
                        <p className="mt-2 text-sm text-gray-500">OTP sent to your email. Valid for 30 seconds.</p>
                    </>
                )}
                ...
                <div className="flex flex-col items-center mt-6 w-full">
                    ...
                    {otpSent && (
                        <button
                            ...
                            className={`mt-4 bg-gray-400 text-white rounded-lg px-4 py-2 w-full hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50 ${!resendAvailable ? 'cursor-not-allowed' : ''}`}
                        >
